...
def motion_detection():
    ...
    ref_frame = None # instinate the first fame
    frame_count = 0
    ...
    while True:
        ...
        frame_delta = cv2.absdiff(ref_frame, greyscale_image) 
        # calculates the absolute diffrence between each element/pixel between the two images, ref_frame - greyscale (on each element)
